...
plugins {
    id("name.djsweet.sidereal.kotlin-application-conventions")
...
dependencies {
    ...
    benchmarksImplementation(project(mapOf("path" to ":sidereal")))
...
application {
    ...
    mainClass.set("name.djsweet.sidereal.AppKt")
}
...
tasks.jar {
    ...
    manifest.attributes["Main-Class"] = "name.djsweet.sidereal.AppKt"
